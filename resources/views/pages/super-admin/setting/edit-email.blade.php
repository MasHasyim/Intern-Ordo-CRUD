        ...
        <div class="pop-up-simpan" id="popUpSimpan">
            <div class="card">
                <div class="title">
                    ...
                    <p class="text-2">Update Email Succesfully</p>
                    <a href="{{ route('backend.settings.index') }}" class="button">OK</a>
                </div>
            </div>
        </div>

        <form method="POST" class="formdata" action="{{ route('backend.setting-email.update', $userMail) }}">
            @csrf
            @method('PUT')
            <div class="top-page">
                <div class="groupDiv">
                    ...
                    <h1 class="text-1">Setting Email Service <span>/ Edit Email Service</span></h1>
                </div>
            ...
            <div class="box">
                <div class="box2">
                    <div class="text-box">
                        ...
                        <input type="text" placeholder="Masukkan Nama" name="name" value="{{ $userMail->name }}">
                    </div>
                </div>
                <div class="box2">
                    <div class="text-box">
                        <p style="margin-bottom: 5px"><span>*</span>Email</p>
                        <input type="text" placeholder="Masukkan Email" name="email" value="{{ $userMail->email }}">
                    </div>
                </div>
            </div>
        </form>
