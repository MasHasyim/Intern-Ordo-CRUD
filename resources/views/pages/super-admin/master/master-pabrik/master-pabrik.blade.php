...
@section('content')
    <div class="master-pabrik">
        ...
        <div class="top-page">
            <h1 class="text-1">Daftar Pabrik</h1>
        </div>
            ...
            <div class="dropdown-group">
                <div class="search-bar">
                    <div class="search-input-container">
                        <input type="text" placeholder="Cari Pabrik...">
                ...
                <div class="button">
                    ...
                    <a href="{{ route('super-admin.master.pabrik.add') }}">Tambah Pabrik</a>
                </div>
            </div>
        </div>
