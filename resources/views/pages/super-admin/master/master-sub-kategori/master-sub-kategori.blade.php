...
@section('content')
    <div class="master-sub-kategori">
        ...
        <div class="top-page">
            <h1 class="text-1">Daftar Sub Kategori</h1>
        </div>
            ...
            <div class="dropdown-group">
                <div class="search-bar">
                    <div class="search-input-container">
                        <input type="text" placeholder="Cari Sub Kategori...">
                ...
                <div class="button">
                    ...
                    <a href="{{ route('super-admin.master.sub-kategori.add') }}">Tambah Sub Kategori</a>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="menu-button">
                                <a class="fa fa-pencil-alt" href="{{ route('super-admin.master.sub-kategori.ubah') }}"
