    ...
    <div class="dashboard-balancing">
        <div class="top-page">
            <a href="{{ route('super-admin.dashboard.index') }}"><img src="{{ asset('images/icon/arrow-back.svg') }}"
                    alt="Ironing"></a>
            <p>List / <span style="font-weight: 700">Folding</span></p>
        </div>
                            ...
                            @for ($i = 0; $i < 5; $i++)
                                <tr>
                                    ...
                                    <td class="text-center"><a
                                            href="{{ route('super-admin.dashboard.folding-detail-1') }}"><i
                        ...
                        <tbody>
                            @for ($i = 0; $i < 5; $i++)
                                <tr>
                                    ...
                                    <td>0.8 Kg</td>
                                    <td class="text-center"><a
                                            href="{{ route('super-admin.dashboard.folding-detail-2') }}"><i
                                                class="fa fa-eye" style="color: #28A745"></i></a></td>
                                </tr>
                            @endfor
                        </tbody>
