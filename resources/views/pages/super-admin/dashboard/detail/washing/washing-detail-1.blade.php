...
@section('content')
    <div class="dashboard-balancing">
        <div class="top-page">
            <a
                href="{{ route('backend.dashboard.on-process.washing.index') . '?factory_id=' . request()->factory_id . '&date1=' . request()->date1 . '&date2' . request()->date2 }}"><img
        ...
        $(document).ready(function() {
            $('#table-master-user').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'collection_form_sku.customer_sku.name'
                    },
                    {
                        data: 'collection_form_sku.customer_sku.fabric_type'
                    },
                    {
                        data: 'machines.machine.code'
                    },
                    {
