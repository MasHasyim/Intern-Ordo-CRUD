...
@section('content')
    <div class="dashboard-trolley-rusak">
        <div class="top-page">
            <a href="{{ route('super-admin.dashboard.index') }}"><img src="{{ asset('images/icon/arrow-back.svg') }}"
                    alt="Ironing"></a>
            <p>List / <span style="font-weight: 700">Trolley Rusak</span></p>
        </div>

        <div class="search-bar2">
            <div class="search-input-container">
                <input type="text" placeholder="Cari berdasarkan ID Trolley" id="searchable">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#table-master-user').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: `{{ route('backend.dashboard.broken.trolleys') }}`,
                },
                columns: [{
                        data: 'id',
                    },
                    ...
                    {
                        data: 'trolley_parent.zone',
                        searchable: false
                    },
                    {
                        data: 'trolley_parent.factory.name',
                        searchable: false
                    }
                ],
                columnDefs: [{
