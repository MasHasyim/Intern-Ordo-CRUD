...
@section('content')
    <div class="dashboard-mesin-rusak">
        <div class="top-page">
            <a href="{{ route('super-admin.dashboard.index') }}"><img src="{{ asset('images/icon/arrow-back.svg') }}"
                    alt="Ironing"></a>
            <p>List / <span style="font-weight: 700">Mesin Rusak</span></p>
        </div>

        <div class="search-bar2">
            <div class="search-input-container">
                <input type="text" placeholder="Cari berdasarkan kode mesin" id="searchable" />
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#table-master-user').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: `{{ route('backend.dashboard.broken.machines') }}`,
                },
                columns: [{
                        data: 'id',
                    },
