                            ...
                            {{-- @for ($i = 0; $i < 5; $i++)
                                <tr>
                                    ...
                                    <td class="text-center"><a
                                            href="{{ route('super-admin.dashboard.washing-detail-1') }}"><i
                        ...
                        <tbody>
                            {{-- @for ($i = 0; $i < 5; $i++)
                                <tr>
                                    ...
                                    <td>0.8 Kg</td>
                                    <td class="text-center"><a
                                            href="{{ route('super-admin.dashboard.washing-detail-2') }}"><i
                                                class="fa fa-eye" style="color: #28A745"></i></a></td>
                                </tr>
                            @endfor --}}
                        </tbody>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#table-master-user').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: `{{ route('backend.dashboard.on-process.delivery.index') }}`,
                    type: 'GET',
                    data: function(d) {
            ...
            $('#table-master-user2').DataTable().on('draw.dt', function() {
                $(this).DataTable().columns.adjust();
            });
